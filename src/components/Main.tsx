...
const Main: React.FC = () => {
  ...
  let desc4 =
    "Online Feedback Portal has now been launched in order to facilitate students so that, they can give their feedback about Course, Teachers and Facilities hassle free";

  let desc5 =
    "MUET Newsletter is a quarterly publication of Public Relations Office.Newsletter showcases memorable events and news related to the University";
  let links = [
    "Gender Equity (USPCAS-W)",
    "MUET Gender Policy Statement",
